...
@endsection
@section('title')
    <title>الأدوار - الندوة العالمية للشباب الإسلامي</title>
@endsection
@section('content')
<div class="mb-5"></div>
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <div class="col-lg-11">
                        <h3 class="card-title hedr-font">الأدوار</h3>
                    </div>
                    <div class="col-lg-1">
                    ...
                    <div class="row">
                                ...
                                <table class="table table-bordered text-nowrap border-bottom" id="responsive-datatable">
                                    <thead class="border-top">
                                        <tr>
                                            ...
                                            <th class="hedr-font text-center">إسم الدور</th>
                                    ...
                                    <tbody>
                                        @foreach ($roles as $role)
                                            <tr class="border-bottom font-center">
                                                ...
                                                <td class="font-14 text-center">{{ $role->name }}</td>
                                                <td class="font-14 text-center">
                                                    <a class="btn btn-secondary" href="{{ route('admin.roles.edit',$role->id) }}">
                        ...
                        @else
                            <div class="alert alert-danger">
                                ...
                                <h1 class="text-center mt-5">عفواً لا يوجد أدوار</h1>
                            </div>
                        @endif
                    </div>
                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h3 class="card-title hedr-font">إضافة دور</h3>
