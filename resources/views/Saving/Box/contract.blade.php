                                                        ...
                                                        @foreach ($savings as $item)
                                                            {{-- @foreach ($user as $us) --}}
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>{{\Carbon\Carbon::parse($item->employee->startdate)->format('Y/m/d');  }}</td>
                                                                    <td class="tit">الراتب</td>
                                                                    <td>{{  number_format($item->employee->salary,2) }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="tit">تاريخ الإشتراك</td>
                                                                    <td>{{ \Carbon\Carbon::parse($item->datePremium)->format('Y/m/d'); }}</td>
                                                                ...
                                                                @foreach ($savings as $item)
                                                                    {{-- @foreach ($user as $us) --}}
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><img src="{{ getImage('Signature/'. $item->signature)}}" alt="Sign"></td>
